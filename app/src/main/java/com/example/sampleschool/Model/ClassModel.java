...
public class ClassModel {
    ...
    public ClassModel(String proctorName, String proctorImage, String className, String docId, Boolean teachingMode, List<SubjectModel> subjects, List<WeekdayModel> timetable, List<AssignmentModel> assignments, List<ExaminationModel> examinations) {
    ...
    public List<WeekdayModel> getTimetable() {
        return Timetable;
    }

    public void setTimetable(List<WeekdayModel> timetable) {
        Timetable = timetable;
    }
}
